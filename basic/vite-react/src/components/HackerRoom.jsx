...
// Component for rendering a 3D hacker room scene
export function HackerRoom(props) {
  // Load the GLTF model and textures using the useGLTF and useTexture hooks
  const { nodes, materials } = useGLTF("/models/hacker-room.glb");
  const monitortxt = useTexture("textures/desk/monitor.png");
  const screenTxt = useTexture("textures/desk/tglogo.jpeg");

  return (
    <group {...props} dispose={null}>
      {/* Monitor screens with a custom screen texture */}
...
// Preload the 3D model to ensure it's ready for rendering
